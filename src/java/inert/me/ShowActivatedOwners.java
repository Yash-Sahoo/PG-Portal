...
public class ShowActivatedOwners extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String sql="select * from users where utype='owner' and status='activated' order by name";
        ...
        try{
            ...
            out.println("<html>");
            out.println("<body>");
            out.println("<h3>Verified Owners</h3>");
            out.println("<hr>");
            ...
            while(rs.next()){
                ...
                out.println("<td><a href='deleteOwnerApplied?id="+email+"'>block</a></td>");
            }
            out.println("</table>");
            out.println("<hr>");
