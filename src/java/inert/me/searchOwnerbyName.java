...
public class searchOwnerbyName extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String name1=request.getParameter("nameofowner");
        String sql="select * from users where utype='owner' and name=? and status='activated'";
