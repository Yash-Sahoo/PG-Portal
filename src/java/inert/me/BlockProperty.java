...
public class BlockProperty extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(b==false){
                ...
                out.println("<html>");
                out.println("<body>");
                out.println("<h2><font face=algerian>Block the Property Details</font></h2>");
                out.println("<hr>");
                ...
                while(rs.next()){
                    ...
                    out.println("<td><a href=BlockingTheProperty?id="+rs.getString("pcode")+">Block</a></td>");
                    out.println("</tr>");
                }
                out.println("</table>");
                out.println("<hr>");
