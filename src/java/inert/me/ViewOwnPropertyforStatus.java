...
public class ViewOwnPropertyforStatus extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(b==false){
                ...
                out.println("<html>");
                out.println("<body>");
                out.println("<h2><font face=algerian>Update your Property Status</font></h2>");
                out.println("<hr>");
            ...
            //    out.println("<th>email</th>");
                ...
                out.println("<th width=90>Status</th>");
                out.println("<th width=90>Update</th>");
                out.println("</tr>");
                while(rs.next()){
                    out.println("<tr>");
            ...
            //        out.println("<td>"+rs.getString("email")+"</td>");
                    ...
                    out.println("<td><center><a href=changePropertyStatus?id="+rs.getString("pcode")+"&status="+rs.getString("status")+">change</a></center></td>");
                    out.println("<td><center><a href=UpdateProperty.jsp?id="+rs.getString("pcode")+">update</a></center></td>");
                    out.println("</tr>");
                }
                out.println("</table>");
                out.println("<hr>");
