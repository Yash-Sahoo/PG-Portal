...
public class ShowAllPropertyUnverified extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String qr="select * from property where permission='denied'";
            ...
            if(b==false){
                ...
                out.println("<th>IVRS Number</th>");
                out.println("<th>Board Type</th>");
                out.println("<th>Verification</th>");
                out.println("</tr>");
                while(rs.next()){
                    out.println("<tr>");
                    ...
                    out.println("<td><a href=activatePropertyCall?code="+rs.getString("pcode")+">Activate</a></td>");
                    out.println("</tr>");
                }
                out.println("</table>");
                out.println("<hr>");
