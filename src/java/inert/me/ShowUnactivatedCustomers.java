...
public class ShowUnactivatedCustomers extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String sql="select * from users where utype='customer' and status='pending'";
        ...
        try{
            ...
            out.println("<html>");
            out.println("<body>");
            out.println("<h3>Unverified Customers</h3>");
            out.println("<hr>");
            ...
            while(rs.next()){
                ...
                out.println("<td><a href='deleteCustomerApplied?id="+email+"'>block</a></td>");
            }
            out.println("</table>");
            out.println("<hr>");
            out.println("<a href=adminDashboard.jsp>Admin-Dashboard</a>");
