...
<%
    ...
    if(b==false){
        ...
        out.println("<hr>");
        out.println("<a href='mailCompose.jsp'>Compose-Mail</a><br>");
        out.println("<a href='MessageSentByOwner.jsp'>Message-Sent</a>");
        out.println("<br>");
        out.println("<hr>");
        out.println("<br>");
...
<html>
    <body>
        ...
        <a href="MessageSentByOwner.jsp">Message-Sent</a>
        <hr>
        <table border="2" cellspacing="2" cellpadding="2">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><%=pcode%></td>
                    <td><%=dt%></td>
                    <td><a href='replyMsgByOwner.jsp?id=<%=from%>&pcode=<%=pcode%>'>reply</td>
                    <td><a href='deleteMsgByOwner?id=<%=Integer.parseInt(rs.getString("msgid"))%>'>remove</td>
                </tr>
                <%
                    }
                %>
