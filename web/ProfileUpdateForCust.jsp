...
<html>
    ...
    <form action="UpdateProfileForCustomer" method="post" onsubmit="return checkAll()">
        <pre>
    ...
    <hr>
    <center>
    <a href="customerDashboard.jsp"><font face="bookman old style" color="white">Customer-Dashboard</font></a>
    </center>
    </body>
</html>
