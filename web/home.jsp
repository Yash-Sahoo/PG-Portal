...
<html lang="en">
<head>
<title>Paying Guest Portal | Minor Project CDGI</title>
<!-- for-mobile-apps -->
...
<header>
	<div class="top-head container">
		<div class="ml-auto text-right right-p">
			<ul>
				<li class="mr-3">
					<span class="fa fa-phone"></span>9928054158,9988569874</li>
	...
	<div class="container">
		...
		<nav class="py-3 d-lg-flex">
			<div id="logo">
				<h1> <a href="home.jsp"><span class="fa fa-free-code-camp"></span> Room | Flat | Apartment </a></h1>
			</div>
			...
			<div class="row">
					...
					<div class="csslider infinity" id="slider1">
						...
						<ul class="banner_slide_bg">
							<li>
								<div class="container-fluid">
									<div class="w3ls_banner_txt">
										<h3 class="b-w3ltxt text-capitalize mt-md-4">Room</h3>
										<h4><span class="fa fa-ils" aria-hidden="true"></span>from</h4>
									<p><span class="fa fa-usd" aria-hidden="true"></span>30<p>
									</div>
								</div>
							</li>
							<li>
								<div class="container-fluid">
									<div class="w3ls_banner_txt">
										<h3 class="b-w3ltxt text-capitalize mt-md-4">Flat</h3>
										<h4><span class="fa fa-ils" aria-hidden="true"></span>from </h4>
									<p><span class="fa fa-usd" aria-hidden="true"></span>60<p>
							...
							<li>
								<div class="container-fluid">
									<div class="w3ls_banner_txt">
										<h3 class="b-w3ltxt text-capitalize mt-md-4">Apartment</h3>
										<h4><span class="fa fa-ils" aria-hidden="true"></span>from </h4>
										<p><span class="fa fa-usd" aria-hidden="true"></span>90<p>
									</div>
								</div>
							</li>
						</ul>
				...
				<div class="col-md-6 px-lg-3 px-0">
					<div class="banner-form-w3 ml-lg-5">
						<div class="padding">
							<form action="checkmaje.jsp" method="post">
								<h5 class="mb-3">Search And Book</h5>
								<div class="form-style-w3layout">
								<input placeholder="Search Location" name="loc" type="text" required="">
					            <input placeholder="Price Range" name="price" type="text" required="">
    ...
    <footer class="footer-content py-3">
        <div class="container py-md-3">
            <div class="footer-top text-center">
                <h2>
                    <a class="navbar-brand pt-3 mb-3" href="home.jsp">
                        <span class="fa fa-free-code-camp"></span> PG Portal
                    </a>
                </h2>
            </div>
            <div class="row footer-top-inner-vv">
                ...
                <div class="col-lg-3 col-sm-6 mt-lg-0 mt-4">
                    <div class="footer-lavi">
                        ...
                        <ul class="list-info-lavi">
                            <li>
                                <a href="home.jsp"><span class="fa fa-angle-double-right" aria-hidden="true"></span>
                                    Home
                                </a>
                            </li>
                            <li>
...
<div class="copy-right-top">
	<p class="copy-right text-center py-4">&copy; 2019 PG Portal. All Rights Reserved | Design by
		<a href=""> Yash Sahoo | Shubham Bhawsar | Yash Mahajan | Swarnika Solanki </a>
	</p>
</div>
<!-- //copyright -->	
